...
for (var question = 0; question < yesNoSolutions.length; question++){
  //console.log(yesNoSolutions[question, 0]);
  var userAnswer = prompt(yesNoSolutions[question][0]).toUpperCase();
  ...
  if(userAnswer === 'YES' || userAnswer === 'NO'){
    if(userAnswer === yesNoSolutions[question][1]){
